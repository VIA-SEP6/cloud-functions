...
test('it should get count per depatment', () => {
	...
	expect(countPerDepartment).toStrictEqual(
		getCountPerDepartment(jsonFile.data)
	);
});

test('it should get genre name count', () => {
	const genreNameCount = {
		Documentary: 42,
		History: 1,
		"TV Movie": 3,
		"Science Fiction": 3,
